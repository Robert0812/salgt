...
def main():
	...
	fc3 = FCLayer(input=conv1.output(), n_in=nfilter1*outL*outL, n_out=2048, actfun=sigmoid, tag='_fc3')
	fc4 = FCLayer(input=fc3.output(), n_in=2048, n_out=256, actfun=sigmoid, tag='_fc4')
