...
from sals.utils.FunctionHelper import get_roc_curve
...
def main():
	...
	supsal_path = '../data_viper/model/salmaps_comparison.pkl'
	...
	salmap_knn_all = [imresize(im, size=mapsz)/255. for im in salmap_knn_small]
